  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b pb-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-[#1b4d3e]">Task & Service Module</h1>
          <p className="text-xs text-muted-foreground mt-0.5">Configure services, SOPs, and task checklists for professional engagements.</p>
        </div>
        <div className="flex items-center gap-2">
          <SearchInput
